import MySQLdb
import archivos.administrador_archivos as admin
from archivos.calculoFacial import getRelacionesURL, getRelaciones
from archivos.generador_pdf import gen_pdf
